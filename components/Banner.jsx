...
const Banner = ({ parentStyles, childStyles, banner }) => (
  <div className={`relative w-full flex items-center z-0 overflow-hidden nft-gradient ${parentStyles}`}><p className={`font-bold text-5xl font-poppins leading-70 dark:text-white text-white ${childStyles}`}>{banner}</p>
